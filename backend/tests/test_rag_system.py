...
class TestRAGSystem:
    ...
    def test_add_course_folder_skip_existing(
        self, test_config, temp_dir, sample_course_doc
    ):
...
"""
        ...
        course_count, chunk_count = rag.add_course_folder(
    ...
    def test_query_without_session(
        self, mock_anthropic, test_config, sample_course_doc
    ):
    ...
    def test_query_with_tool_execution(
        ...
        mock_final_response.content = [
            Mock(text="Based on the course content, Python is...")
        ]
