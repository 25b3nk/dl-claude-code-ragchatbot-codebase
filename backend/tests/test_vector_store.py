...
class TestVectorStore:
    ...
    def test_add_course_metadata(self, vector_store):
        ...
        course = Course(
            ...
            lessons=[
                ...
                Lesson(lesson_number=2, title="Lesson 2", lesson_link="https://example.com/2")
            ]
        )
    ...
    def test_search_with_lesson_filter(self, vector_store):
        ...
        results = vector_store.search("content", course_name="Test Course", lesson_number=2)
        assert not results.is_empty()
    ...
    def test_document_processing_integration(self, document_processor, vector_store, sample_course_doc):
