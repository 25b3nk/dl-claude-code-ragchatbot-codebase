...
class TestCourseSearchTool:
    ...
    def test_execute_nonexistent_course(self, vector_store):
        ...
        assert "No course found matching" in result or result.startswith("No course found")
    ...
    def test_sources_tracking(self, vector_store):
        ...
        course = Course(
            title="Test Course",
            lessons=[Lesson(lesson_number=1, title="Lesson 1", lesson_link="https://example.com/1")]
        )
        vector_store.add_course_metadata(course)
...
class TestCourseOutlineTool:
    ...
    def test_execute_course_outline(self, vector_store):
        ...
        course = Course(
            ...
            instructor="Jane Doe",
            lessons=[
                Lesson(lesson_number=1, title="Introduction", lesson_link="https://example.com/1"),
                Lesson(lesson_number=2, title="Variables", lesson_link="https://example.com/2"),
                Lesson(lesson_number=3, title="Functions", lesson_link="https://example.com/3")
            ]
        )
        vector_store.add_course_metadata(course)
...
class TestToolManager:
    ...
    def test_get_last_sources(self, vector_store):
        ...
        course = Course(
            ...
            lessons=[Lesson(lesson_number=1, title="Test Lesson", lesson_link="https://example.com/1")]
        )
        vector_store.add_course_metadata(course)
