...
class CourseOutlineTool(Tool):
    """Tool for getting course outlines with titles, links, and complete lesson lists"""
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "description": "Get complete course outline including title, course link, and all lessons with their titles and numbers",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_name": {
    ...
    def execute(self, course_name: str) -> str:
        ...
        # Step 2: Get course metadata including lessons
        try:
